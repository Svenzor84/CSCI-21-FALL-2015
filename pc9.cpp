 ...
 * Created by Steve Ross-Byers on Sept 20 2015
 */
#include <cassert>
#include <iomanip>
#include <iostream>
...
string Spaceship::toString () const{
  ...
  //Make sure topSpeed member variable has two decimal places
  ss.setf(ios::fixed);
  ss.setf(ios::showpoint);
  ss.precision(2);
  
  //Load up the string stream with member variables and formatting
