 ...
 * Created by Steve Ross-Byers on Sept 2 2015
 */
#include <cassert>
#include <cstdlib>
#include <iostream>
...
double stringToDouble (string value) {
	// CODE HERE
	//the exact same function as previous example, but for doubles...
...
bool stringToBool (string value) {
	...
	if (value.empty() == true){
		return false;
	//if the first character is 'T' or 't' return True
	} else if (toupper(value.at(0)) == 'T'){
		return true;
