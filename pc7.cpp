...
bool processFile (string filename){
	//declare input file stream and open the file named in string argument
	ifstream ifs(filename.c_str());
	//declare the var to hold each incoming number
	int fileValue;
	...
	//read each line of the file and check to see which function to invoke,
	...
	//close the file and report successful file stream
	ifs.close();
	return true;
}
...
void unittest () {
	...
	counters[10] = 0, counters[20] = 0, counters[30] = 0, counters[40] = 0, counters[50] = 0;
