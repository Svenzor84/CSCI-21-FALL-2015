...
bool ShoppingList::addItem (string theItem) {
    ...
    //if the list is not full add the item and increment item count
    if (itemCount < maxItems){
        ...
        //return false to report a full list
        return false;
    }
}
...
string ShoppingList::getItem (unsigned int index) const {
    ...
    //if the index is valid, return the value
    if (index < itemCount){
        return items[index];
    } else {
...
string& ShoppingList::getItem (unsigned int index) {
    ...
    //if the index is valid return the reference
    if (index < itemCount){
        return items[index];
    } else {
